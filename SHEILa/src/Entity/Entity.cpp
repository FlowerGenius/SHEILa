...
template<class _Te>
std::vector<cpp::Cpp::Project::Artifact::Object_base> 	Entity<_Te>::this_object_parents;

template<class _Te>
std::vector<cpp::Cpp::Project::Artifact::Object_base> 	Entity<_Te>::this_object_children;
#endif
